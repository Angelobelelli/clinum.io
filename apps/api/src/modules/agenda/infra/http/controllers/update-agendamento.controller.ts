...
import { updateAgendamentoSchema } from '@/modules/agenda/dto/update-agendamento.schema';
import type { UpdateAgendamentoInput } from '@/modules/agenda/dto/update-agendamento.schema';
